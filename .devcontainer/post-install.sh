...
sh -c "SOLANA_RELEASE=v1.18.0
SOLANA_INSTALL_INIT_ARGS=v1.18.0
...
export PATH="/home/vscode/.local/share/solana/install/active_release/bin:/vscode/bin/linux-x64/7c6fdfb0b8f2f675eb0b47f3d95eeca78962565b/bin/remote-cli:/usr/local/share/nvm/versions/node/v18.20.8/bin:/usr/local/cargo/bin:/usr/local/cargo/bin:/usr/local/share/nvm/versions/node/v18.20.8/bin:/usr/local/cargo/bin:/usr/local/cargo/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/home/vscode/.local/bin"
echo 'export PATH="/home/vscode/.local/share/solana/install/active_release/bin:/vscode/bin/linux-x64/7c6fdfb0b8f2f675eb0b47f3d95eeca78962565b/bin/remote-cli:/usr/local/share/nvm/versions/node/v18.20.8/bin:/usr/local/cargo/bin:/usr/local/cargo/bin:/usr/local/share/nvm/versions/node/v18.20.8/bin:/usr/local/cargo/bin:/usr/local/cargo/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/home/vscode/.local/bin"' >> ~/.bashrc

# Install Rust SBF toolchain
echo "Installing Rust SBF toolchain..."
rustup component add rust-sbf
...
solana --version || echo "Solana install failed"
anchor --version || echo "Anchor install failed"
rustup show
